    ...
    <div>
      <div className="flex items-center justify-between mb-3">
        <span className="font-inter text-sm font-medium text-charcoal uppercase tracking-wide">
          Size: <span className="text-emerald font-semibold">{selectedSize}</span>
        </span>
        <button className="font-inter text-xs text-charcoal/50 hover:text-emerald transition-colors underline underline-offset-2">
          Size Guide
        </button>
      </div>
      ...
      <p className="font-inter text-xs text-charcoal/50 mt-3">
        Need a custom size?{" "}
        <a href="/contact" className="text-emerald hover:underline">Contact us</a>
        {" "}for tailored orders.
      </p>
    </div>
  );
